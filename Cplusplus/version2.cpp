...
int main() {
    // Configuración para que la consola acepte tildes y eñes
    ...
    cout << "=== CLIENTE SOAP C++ - VERSION 2 (TRADUCTOR) ===" << endl;
    ...
    // Estructura XML SOAP idéntica a la que piden los profesores
    ...
    HINTERNET hInternet = InternetOpenA("ClienteSOAP", INTERNET_OPEN_TYPE_DIRECT, NULL, NULL, 0);
    ...
    if (bSend) {
        ...
        // Extracción de la respuesta del XML
        ...
        if (start != string::npos && end != string::npos) {
            ...
            cout << "\n========================================" << endl;
            cout << "Resultado (" << idioma << "): " << resultado << endl;
            cout << "========================================" << endl;
        } else {
            cout << "\nError: Estructura de respuesta incorrecta." << endl;
        }
    } else {
